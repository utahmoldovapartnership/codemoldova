...
const footerLinkBase = `block py-2.5 text-sm font-mono transition-colors sm:py-2 ${focusRing}`
...
export default function Footer() {
  ...
  return (
    <footer
      ...
      role="contentinfo"
    >
      <div className="layout-shell border-t border-white/[0.08] pt-10 sm:pt-12">
        <h2 id="footer-nav-heading" className="sr-only">
          Footer navigation
        </h2>

        <div className="grid gap-10 sm:grid-cols-2 sm:gap-x-10 lg:grid-cols-3 lg:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="mt-2 font-mono text-[11px] text-muted sm:text-xs">May – July 2026</p>
          </div>
      ...
      <div className="layout-shell mt-10 border-t border-white/[0.06] pt-8 pb-2 sm:mt-12 sm:pt-8 sm:pb-2">
        <p className="text-center font-mono text-[10px] leading-relaxed text-muted sm:text-[11px]">
          © {year} CodeMoldova. All rights reserved.
        </p>
        <p className="mx-auto mt-2 max-w-3xl text-center font-mono text-[10px] leading-relaxed text-muted/90 sm:text-[11px]">
          This site and course materials are provided for enrolled students and applicants as a free, nonprofit
          educational program.
        </p>
      </div>
    </footer>
