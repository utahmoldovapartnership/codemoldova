...
const BY_KEY = {
  ...
  '2:mon': [
    {
      ...
      items: [
        ...
        {
          label: 'Dictionaries in Python (Real Python)',
          href: 'https://realpython.com/python-dicts/',
          source: 'realpython.com',
          note: 'Patterns for counting, grouping, and lookups.',
        },
      ],
    },
    {
  ...
  '2:thu': [
    ...
    },
    {
      ...
      items: [
        {
          label: 'Working with JSON in Python',
          href: 'https://www.youtube.com/watch?v=9syDWl19th0',
          source: 'YouTube',
          note: 'From response text to Python objects.',
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          source: 'httpbin.org',
          note: 'Test URLs and inspect headers in the browser.',
        },
      ],
    },
  ],
      ...
      items: [
        {
          ...
          source: 'python.org',
          note: 'Parameters, return, default arguments.',
        },
        {
          label: 'Real Python — Python functions',
          href: 'https://realpython.com/defining-your-own-python-function/',
          source: 'realpython.com',
          note: 'Style and common patterns.',
        },
      ],
    },
    {
      ...
      items: [
        {
          label: 'Python functions for beginners',
          href: 'https://www.youtube.com/watch?v=9Os0o3wzS_I',
          source: 'YouTube',
          note: 'Syntax and flow in ten minutes.',
        },
      ],
    },
    {
      ...
      items: [
        {
          label: 'Documenting Python code (PEP 257)',
          href: 'https://peps.python.org/pep-0257/',
          source: 'python.org',
          note: 'One-line docstrings and conventions.',
        },
      ],
    },
  ],
