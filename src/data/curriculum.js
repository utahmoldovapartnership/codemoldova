    ...
    weeks: [
      {
        ...
        wed: {
          title: "Logic + loops",
          date: "May 13",
          desc: "Workshop 2: teach the computer to branch and repeat. We stay in Cursor\u2014use a fresh .ipynb or a small week1_wed.py file so you can run snippets quickly and see output beside your notes.",
          preview: "if / elif / else, comparisons, for and while loops, and a few loop patterns you will reuse all course.",
          steps: [
            {
              title: "Warm-up: truthy values",
              content: "Booleans True/False and expressions that collapse to a decision. Review comparison operators == != < > <= >= and combining ideas with and / or.",
              task: "In a notebook cell, predict then run: 3 < 5, \"hello\" == \"Hello\", (10 > 5) and (2 == 2).",
              code: { lang: "python", snippet: "print(3 < 5)\nprint(10 > 2 and 2 != 3)" },
            },
            {
              title: "if / elif / else",
              content: "Run different blocks based on state. Indentation is part of Python syntax—Cursor shows whitespace guides; keep blocks consistent.",
              task: "Write a program that reads a temperature (float) and prints whether it feels hot, warm, or cold using your own thresholds.",
              code: { lang: "python", snippet: "t = float(input(\"Temp C? \"))\nif t >= 28:\n    print(\"hot\")\nelif t >= 15:\n    print(\"warm\")\nelse:\n    print(\"cold\")" },
            },
            {
              title: "for loops with range and sequences",
              content: "Use for when you can name the collection or a numeric range. range(stop), range(start, stop), and range(start, stop, step) cover most counting loops.",
              task: "Print squares 1..10. Then loop a list of three cities you like and print each on its own line.",
              code: { lang: "python", snippet: "for n in range(1, 11):\n    print(n * n)" },
            },
            {
              title: "while loops and sentinels",
              content: "while keeps going while a condition is true—handy for menus and games. Always ensure something inside the loop can change the condition, or you spin forever.",
              task: "Write a tiny menu loop: keep asking “again? (y/n)” until the user types n.",
            },
            {
              title: "Trace a loop on paper",
              content: "Debugging loops is easier when you track variables by hand for one or two iterations.",
              task: "Pick a 4-line loop from class. Write a table: iteration index, variable values, printed line.",
            },
          ],
          homework: {
            title: "Loop drills",
            desc: "Practice in the same week1 notebook or a new week1_wed_practice.ipynb in Cursor.",
            tasks: [
              "FizzBuzz from 1 to 40 using a for loop and modulo.",
              "Ask how many laps; use a for loop to print Lap 1 … Lap N.",
              "Optional: print a tiny ASCII staircase of # characters using nested loops.",
            ],
          },
        },
        thu: {
