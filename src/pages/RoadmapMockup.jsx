...
function ThisWeekHero({ status, currentWeek }) {
  ...
  return (
    <section className="border-b border-dart/85 bg-paper">
      <div className="border-b border-dart/85 px-6 py-12 sm:px-10 sm:py-16">
...
function WeekRow({ weekNum, isCurrent, isOpen, onToggle }) {
  ...
  return (
    <li className={`border-b border-dart/85 ${isCurrent ? 'bg-val/[0.04]' : ''}`}>
      <button
        type="button"
        onClick={onToggle}
      ...
      {isOpen ? (
        <div className="border-t border-dart/85 bg-paper py-6 sm:py-8">
            ...
            {['mon', 'wed', 'thu'].map((day) => {
              ...
              return (
                <Link
                  ...
                  className="group flex flex-col justify-between border border-dart/85 bg-paper p-5 transition-colors hover:bg-ink hover:text-paper"
                >
                  <div>
                    ...
                    <p className="mt-1 font-mono text-[11px] uppercase tracking-[0.2em] text-ink/50 group-hover:text-paper/50">
...
function CompleteRoadmap({ currentWeek }) {
  ...
  return (
    <section id="full-roadmap" className="border-b border-dart/85 px-6 py-20 sm:px-10 lg:py-28">
      <div className="mb-10 flex items-end justify-between gap-6 border-b border-dart/85 pb-8">
        <div>
      ...
      {phases.map((phase, phaseIdx) => (
        <div key={phase.id ?? phaseIdx} className="mt-14 first:mt-0">
          <div className="mb-3 flex flex-wrap items-baseline gap-x-4 gap-y-1 border-t border-dart/85 pt-6">
          ...
          <ul className="border-t border-dart/85">
